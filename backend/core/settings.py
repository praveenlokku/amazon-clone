...
# Email Settings
# If you want to use a real SMTP server (like Gmail), set these in your .env file
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', f"Amazon Clone <{EMAIL_HOST_USER}>")
